...
import { selectPlayerToFight,
    ...
    export function addImage(team, playersArray, countVar, originalContainerId, targetContainerId, toggleFunction) {
        ...
        const buttons = [
            ...
            { divId: `returnFromFightDiv-${uniqueId}`, buttonId: `removeFromFightButton-${uniqueId}`, imgSrc: 'images/return.png', clickHandler: () => removeFromFight(uniqueId, team),imgClass: team === 'maccabi' ? 'return-maccabi-class button-image' : 'return-hapoel-class button-image' }
        ];
