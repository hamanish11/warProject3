                ...
                case 'ginat':
                    htmlString = `
                        <p class="descriptionHapoel">
                            ...
                            <img class="ginat" src="images/ginat info 2.png">
                            <img class="ginat" src="images/hapoel icon.png">
                        </p>
                        `;
                    buttonsString = `
                ...
                case 'timor':
                    htmlString = `
                        <p class="descriptionHapoel">
                            ...
                            <img class="timor" src="images/timor info 2.png">
                            <img class="ginat" src="images/hapoel icon.png">
                ...
                case 'munford':
                    htmlString = `
                        <p class="descriptionHapoel">
                            ...
                            <img class="munford" src="images/munford info 2.png">
                            <img class="ginat" src="images/hapoel icon.png">
                        `;
                    buttonsString = `
                        <button id="${removeButtonId}" class="addbutton red-button">
            ...
            switch (player.name) {
                case 'dibartolomeo':
                    htmlString = `
                        ...
                        <img class="munford" src="images/dibartolomeo info 2.png">
                ...
                case 'blatt':
                    htmlString = `
                        ...
                        <img class="munford" src="images/blatt info 2.png">
                        <img class="ginat" src="images/maccabi info 2.png">
                        `;
                    buttonsString = `
                        <button id="${removeButtonId}" class="addbutton yellow-button">
                ...
                case 'rivero':
                    htmlString = `
                        ...
                        <img class="munford" src="images/rivero info 2.png">
                        <img class="ginat" src="images/maccabi info 2.png">
                        `;
                    buttonsString = `
                        <button id="${removeButtonId}" class="addbutton yellow-button">
